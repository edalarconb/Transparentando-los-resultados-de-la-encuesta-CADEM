...
n=708 ## nro de encuestados
llamados=5841 ## nro de llamadas hasta lograr 704 seleccionados que contestan la encuesta
...
#################################
a=round(n*0.39);a #nro personas aprueba
b=round(n*0.50);b #nro personas desaprueba
c=round(n*0.06);c #nro personas ni aprueba ni desaprueba
d=round(n*0.05);d #nro personas no sabe no responde
...
#########################################
a=round(n*0.46);a #nro personas rechaza convención
b=round(n*0.38);b #nro personas aprueba convención
