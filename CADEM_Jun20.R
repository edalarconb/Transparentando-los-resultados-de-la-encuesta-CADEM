...
llamados=6551 ## nro de llamadas hasta lograr 704 seleccionados que contestan la encuesta
...
#################################
a=round(n*0.40);a #nro personas aprueba
b=round(n*0.54);b #nro personas desaprueba
c=round(n*0.02);c #nro personas ni aprueba ni desaprueba
...
b=round(n*0.37);b #nro personas aprueba convención
c=round(n*0.17);c #nro personas no sabe o no responde
