...
llamados=7380 ## nro de llamadas hasta lograr 704 seleccionados que contestan la encuesta
...
#################################
a=round(n*0.36);a #nro personas aprueba
b=round(n*0.57);b #nro personas desaprueba
...
#########################################
a=round(n*0.45);a #nro personas rechaza convención
