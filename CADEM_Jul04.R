...
n=707 ## nro de encuestados
llamados=6997 ## nro de llamadas hasta lograr 704 seleccionados que contestan la encuesta
...
#########################################
a=round(n*0.34);a #nro personas aprueba convención
b=round(n*0.51);b #nro personas rechaza convención
c=round(n*0.15);c #nro personas no sabe o no responde
