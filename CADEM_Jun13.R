...
llamados=6437 ## nro de llamadas hasta lograr 704 seleccionados que contestan la encuesta
...
#################################
a=round(n*0.44);a #nro personas aprueba
b=round(n*0.48);b #nro personas desaprueba
...
#########################################
a=round(n*0.43);a #nro personas rechaza convención
b=round(n*0.39);b #nro personas aprueba convención
c=round(n*0.18);c #nro personas no sabe o no responde
